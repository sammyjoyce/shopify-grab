...
const MoreOptionsButton: Component<MoreOptionsButtonProps> = (props) => {
  return (
    <button
      ...
      data-shopify-grab-more-options
        ...
        <BottomSection>
          ...
          >
            <textarea
              ref={inputRef}
              data-shopify-grab-ignore-events
              data-shopify-grab-followup-input
            ...
            />
            <button
              data-shopify-grab-followup-submit
              class={cn(
